 ...
 */
  ...
  public void setCandidates(String words, boolean highlightDefault) {//显示候选区  sfb
  ...
  public void candidateView_invalidate(){
	  candidateView.invalidate();
  }

  public void candidateView_pick(int x,int y){
	if (candidateView.updateHighlight(x, y)) {
		candidateView.pickHighlighted();
    }
  }
  
  public void setHilightIndex(int highlightIndex) {
	candidateView.setHighlightIndex(highlightIndex);
  }
